...
export class Et3400 {
    ...
    /**
     * Loads a program into the ET3400 microprocessor. This method bypasses the
     * normal MPU memory loading based on clock cycles.  As Such, it should
    ...
    loadProgram(address, string) {
        ...
        const length = string.length;
        for (let index = 0; index < length; index++) {
            this.memory.content[this.microprocessor.programCounter++] = string.charCodeAt(index);
        }
    }
